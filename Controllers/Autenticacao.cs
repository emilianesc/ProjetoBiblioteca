    ...
    public class Autenticacao
    {
...

        {
...

            {
                ...
                IQueryable<Usuario> UsuarioEncontrado = bc.Usuario.Where(user => user.Login == Login && user.Senha == Senha);
...

        {
            ...
            IQueryable<Usuario> userEncontrado = bc.Usuario.Where(user => user.Login == "admin");
